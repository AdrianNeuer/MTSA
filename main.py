...
def get_args():
    ...
    parser.add_argument('--ratio_train', type=float, default=0.7, help='train dataset length')
    parser.add_argument('--ratio_val', type=float, default=0, help='validate dataset length')
    parser.add_argument('--ratio_test', type=float, default=0.3, help='input sequence length')

    # transform parameter
    parser.add_argument('--box_lambda', type=float, default=0.5, help='box-cox lambda')
